...
class userInfo(models.Model):
    ...
    department = models.ForeignKey(verbose_name='所属部门',to=department,to_field="id",on_delete=models.CASCADE,null=True)
    company = models.ForeignKey(verbose_name='所属公司',to=company,to_field="id",on_delete=models.CASCADE,null=True)
