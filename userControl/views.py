...
def insertUser(request):
    ...
    if request.method == "POST":
        ...
        userInfo.objects.create(username=username,password=password,real_name=real_name,phone=phone,comment=comment)
...
def update(request,id):
    ...
    if request.method == "POST":
        ...
        try:
            company_obj = company.objects.get(name=updatecompany)
        except:
            company_obj = company.objects.create(name=updatecompany)
        try:
            department_obj = department.objects.get(name=updatedepartment)
        except:
            department_obj = department.objects.create(name=updatedepartment)
        user_obj.username = username
        user_obj.real_name = real_name
        user_obj.phone = phone
        user_obj.company = company_obj
        user_obj.department = department_obj
